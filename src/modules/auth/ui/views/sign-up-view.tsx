          ...
          <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="p-6 md:p-8">
              <div className="flex flex-col gap-6">
                ...
                <div className="after:border-border relative text-center text-sm after:absolute after:inset-0 afer:top-1/2 after:z-0 after:flex after:items-center after:border-t">
